    ...
    <>
      ...
      >
        <div className="text-center py-4">
          <p className="text-base font-medium text-primary mb-6">Are you sure Turn off this Department</p>
      ...
      >
        <div className="text-center py-4">
          <p className="text-lg font-medium mb-6">Are you sure Remove this Department</p>
          <div className="flex justify-center gap-4">
            <Button
      ...
      <DepartmentManagementFormModal mode="edit" visible={editModalVisible} onCancel={() => setEditModalVisible(false)} /> {/* initialValues={institution} */}
...
export default DepartmentManagementTableBody;