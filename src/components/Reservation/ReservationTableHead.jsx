...
import EarningTableBody from "../Earning/EarningTableBody";
import ReservationTableBody from "./ReservationTableBody";

const ReservationTableHead = ({ columns }) => {
    ...
    <div className="overflow-x-auto">
      <div className="min-w-[1200px] w-full bg-transparent rounded-lg shadow-md space-y-3">
        ...
        <div className="grid grid-cols-12 text-center border-2 border-opacity-50 rounded-lg bg-surfacePrimary px-2 border-primary">
          ...
          <div className="col-span-2 py-3 font-semibold">Status</div>
          <div className="col-span-1 py-3 font-semibold">Action</div>
        </div>
        ...
        <div className="border-2 border-opacity-50 rounded-lg bg-surfacePrimary border-primary">
          {demoData.length > 0 ? (
            demoData.map((item) => (
              <ReservationTableBody item={item} key={item.id} />
            ))
          ) : (
